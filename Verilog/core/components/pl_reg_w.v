...
always @(posedge clk) begin
    if (!clr || flush) begin
        ...
        excDecW <= 0; tretW <= 0; wfiW <= 0; memMisAlignLoadW <= 0; memMisAlignStoreW <= 0;
        ...
        tretW <= tretM; wfiW <= wfiM; memMisAlignLoadW <= memMisAlignLoadM; memMisAlignStoreW <= memMisAlignStoreM;
    end
end
