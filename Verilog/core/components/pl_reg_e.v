...
always @(posedge clk) begin
    if (clr) begin
        ...
        ALUSrcE <= 0; PCE <= 0; InstrE <= 0; excDecE <= 0; tretE <= 0; wfiE <= 0; validE <= 0;
        ...
        excDecE <= excDecD; tretE <= tretD; wfiE <= wfiD; validE <= validD;
    end
end
