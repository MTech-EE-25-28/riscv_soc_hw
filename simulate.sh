...
case "$TB_NAME" in
tb_pl) HEX_ARG="+HEX=./compiler/bin/rv32i_test.hex" ;;
tb_program) HEX_ARG="+HEX=./compiler/bin/matrix_mul.hex" ;;
tb_exception) HEX_ARG="+HEX=./compiler/bin/exception.hex" ;;
tb_interrupt) HEX_ARG="+HEX=./compiler/bin/interrupt.hex" ;;
tb_soc) HEX_ARG="+HEX=./compiler/bin/soc_test.hex" ;;
tb_soc_timer) HEX_ARG="+HEX=./compiler/bin/mtimer_test.hex" ;;
tb_soc_mm) HEX_ARG="+HEX=./compiler/bin/sw_matrix_mul.hex" ;;
tb_free_run) HEX_ARG="+HEX=./compiler/bin/blink_test.hex" ;;
*) HEX_ARG="" ;;
esac
